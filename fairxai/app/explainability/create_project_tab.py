...
def create_project_page():
    ...
    project_name = st.text_area("Nome del progetto",
                                value="Project-{0}".format(datetime.datetime.now().strftime('%Y%M%d-%H%M')))
    ...
    if creating is True:
        try:
            ...
            project = Project(
                ...
                categorical_columns=[c.strip() for c in
                                     categorical_columns.split(",")] if categorical_columns != None else None,
